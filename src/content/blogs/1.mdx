...
<div className="author-meta mb-8 flex items-center gap-3 pt-4  border-border/30">
  ...
  <div>
    ...
    <p className="text-xs text-text-secondary">October 15, 2025</p>
...
Here’s the link to the github repository containing the source code: [tictactoe-nakama](https://github.com/mdrazak2001/tictactoe-nakama)
