...
![Architecture Diagram](/blogs/1/image.png)


Nakama also needs a data persistence to store data in the long term. It currently is compatible with cockroach db and postgresql.

## Architecture

The Http port handles stateless operations like authentication/fetching leaderboard/user profiles.
The web socket port handles any real time match updates, player moves…
...
Here’s the link to the github repository containing the source code: 

Conclusion
Building this game taught me a lot more than expected about distributed systems. Have any questions or wanna connect, reach out to me at my mail or X at the top, hope you learned something, thanks for reading!
